...
const ProjectMenu = ({ anchorEl, open, handleClose }) => {
  ...
  Object.entries(projects).forEach(([projectId, project]) => {
    if (project.type === 'owned') {
      owned_projects.push(projectId)
    } else {
      joined_projects.push(projectId)
    }
  })
    ...
    <StyledMenu
      ...
      {!emptyProjects && (
        <MenuItem
          ...
          <Typography variant="overline">View All Projects</Typography>
        </MenuItem>
      )}
      {!emptyProjects && <Divider />}
                ...
                {section.projectItems.map((projectId) => {
                  ...
                  return (
                    <MenuItem
                      ...
                      <Avatar
                        variant="rounded"
                        {...stringAvatar(project.name, project.backgroundColor)}
                      />
                      <Box>
                        <Typography className="projectName">
                          {project.name}
